            ...
            $.get("/koperasi/neraca/" + id)
                .then(res => {
                    res.map(data => {
                        ...
                        let atmr15 = (data.simpanan_pokok + data.simpanan_wajib + data.modal_penyetaraan + (data.modal_penyertaan / 2) + data.modal_sumbangan + data.cadangan_umum + (data.cadangan_tujuan / 2) - (data.shu_sebelum / 2))

                        let kpr2 = (((atmr15 / jmlakt) * 100).toFixed(2));

                        if (kpr2 == Infinity) {
                            kpr2 = 0;
                        } else if (isNaN(kpr2)) kpr2 = 0;
                        ...
                        if (kpr2 <= 4) {
                            $("#kpk2").text("Tidak Baik");
                        } else if (kpr2 <= 6) {
                            $("#kpk2").text("Kurang Baik");
                        } else if (kpr2 <= 8) {
                            $("#kpk2").text("Cukup Baik");
                        } else {
                            $("#kpk2").text("Baik");
                        }
