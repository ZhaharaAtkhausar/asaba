        ...
        $("#search").on("change", function() {
            ...
            .then(res => {
                ...
                res.map(data => {
                    ...
                    //hasil query phu
                    let jml_prtianggota = data.jasa_pinjaman + data.administrasi_anggota + data.provisi_anggota + data.pelayanan_lain;
                    let jml_prtianggota2 = data.jasa_pinjaman2 + data.administrasi_anggota2 + data.provisi_anggota2 + data.pelayanan_lain2;
                    let jml_pendnon = data.jasa_pinjaman_non + data.administrasi + data.provisi + data.jasa_pelayanan;
                    let jml_pendnon2 = data.jasa_pinjaman_non2 + data.administrasi2 + data.provisi2 + data.jasa_pelayanan2;
                    ...
                    let jml_eku = data.simpanan_pokok + data.simpanan_wajib + data.modal_penyetaraan + data.modal_sumbangan + data.cadangan_umum + data.cadangan_tujuan + (data.shu_berjalan - data.shu_sebelum);
                    let jml_aktlancar = jml_kasbnk + data.surat_berharga + (jml_piutang - data.penyisihan_pinjaman) + data.premi_asuransi + data.perkap_kantor + data.beban_dimuka + data.pendapatan_aknditerima + data.barang_dagang + data.lainnya;

                    let jml_kweku = kw_lancar + (data.hutang_bank_panjang + data.hutang_koplain + data.pasiva + data.simpanan_berjangka + data.titipan_dana_panjang + data.hutang_lpdb_panjang + data.hutang_sewa_panjang + data.hutang_lain + data.modal_penyertaan) + (data.simpanan_pokok + data.simpanan_wajib + data.modal_penyetaraan + data.modal_penyertaan + data.modal_sumbangan + data.cadangan_umum + data.cadangan_tujuan + (data.shu_berjalan - data.shu_sebelum));
                    let jmlakt = jml_aktlancar + (data.tabungan_berjangka + data.surat_berharga_panjang + data.simpanan_lain + data.penyertaan_koplain + data.penyertaan_lemkeulain + data.inv_jplain) + ((data.tanah + data.bangunan + data.kendaraan + data.inv_perkap) - data.akm_peny) + (data.aktiva_tdk_berwujud) + (data.beban_ditangguhkan + data.amortisasi_beban + data.agunan_diambil + data.beban_praoperasional + data.amortisasi_biaya + data.lain);
                    let jmlakt2 = (data.kas2 + data.giro2 + data.tabungan2 + data.deposito2 + data.simpanan_sukarela2 + data.simpanan_berjangka_koplain2 + data.surat_berharga2 + (data.piutang_anggota2 + data.piutang_calon2 + data.piutang_koplain2 + data.piutang_bunga2 + data.piutang_lain2 - data.penyisihan_pinjaman2)) + (data.tabungan_berjangka2 + data.surat_berharga_panjang2 + data.simpanan_lain2 + data.penyertaan_koplain2 + data.penyertaan_lemkeulain2 + data.inv_jplain2) + ((data.tanah2 + data.bangunan2 + data.kendaraan2 + data.inv_perkap2) - data.akm_peny2) + (data.aktiva_tdk_berwujud2) + (data.beban_ditangguhkan2 + data.amortisasi_beban2 + data.agunan_diambil2 + data.beban_praoperasional2 + data.amortisasi_biaya2 + data.lain2);
                    let jml_eku2 = data.simpanan_pokok2 + data.simpanan_wajib2 + data.modal_penyetaraan2 + data.modal_sumbangan2 + data.cadangan_umum2 + data.cadangan_tujuan2 + (data.shu_berjalan2 - data.shu_sebelum2);
