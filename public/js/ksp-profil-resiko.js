            ...
            .then(res => {
                if (res.length < 1) {
                    ...
                    res.map(data => {
                            ...
                            let d25 = data.piutang_anggota + data.piutang_calon + data.piutang_koplain + data.piutang_bunga + data.piutang_lain;
                            let d26 = data.penyisihan_pinjaman;
                            ...
                            let d49 = data.simpanan_berjangka + data.surat_berharga + data.simpanan_lain + data.penyertaan_koplain + data.penyertaan_lemkeulain + data.inv_jplain;
                            ...
                            let d27 = d25 - d26;
                            //set to resiko kredit
                            let rkrr1 = ((d17 + d27) / d68).toFixed(2);
                            if (rkrr1 == Infinity) {
                                rkrr1 = 0;
                            } else if (isNaN(rkrr1)) rkrr1 = 0;
                            ...
                            if (rkrr1 <= 95) {
                                $("#rkrk1").text("Tidak Baik");
                            } else if (rkrr1 <= 97) {
                                $("#rkrk1").text("Kurang Baik");
                            } else if (rkrr1 <= 99) {
                                $("#rkrk1").text("Cukup Baik");
                            } else {
                                $("#rkrk1").text("Baik");
                            }
