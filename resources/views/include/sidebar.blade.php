<div class="app-sidebar colored">
    <div class="sidebar-header">
        <a class="header-brand" href="{{route('dashboard')}}">
            <div class="logo-img">
               <h3 class="header-brand-img"> SNAKi </h3>
            </div>
        </a>
        ...
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item  has-sub">
                    <a href="#"><i class="ik ik-layout"></i><span> Bahan Baku </a>
                    <div class="submenu-content">
                        <a href="{{url('bahan-baku-tetap')}}" class="menu-item" >Bahan Baku Tetap</a>
                        <a href="{{url('bahan-baku-lancar')}}" class="menu-item" >Bahan Baku Lancar</a>
                    </div>
                </div>
