            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header row">
                        <div class="col col-sm-5">
                            <!-- <div class="card-options">
                                <a href="{{ url('bahan-baku-tetap/tambah') }}" class=" btn btn-outline-primary btn-semi-rounded "> Tambah Produkx </a>
                            </div> -->
                        </div>
                    </div>
                    <div class="card-body">
                    <table id="advanced_table" class="table">
                            ...
                            <tbody id="result">
                                @foreach ($bahan_baku_tetap as $bbt)
                                    <tr>
                                        <td>{{ $idx }}</td>
                                        <td>{{ $bbt->nama }}</td>
                                        <td>{{ $bbt->harga }}</td>
                                        <td>
                                            <a href="#editKoperasi" data-toggle="modal" data-id="{{ $bbt->id }}" data-target="#editKoperasi" id="edit">
                                                <i class="ik ik-edit f-16 mr-15 text-green"></i>
                                            </a>
                                            <!-- <a href="#" data-id="{{ $bbt->id }}" id="delete"><i class="ik ik-trash-2 f-16 text-red"></i></a> -->
                                        </td>
                                        <td hidden>{{ $idx++ }}</td>
                                    </tr>
                                @endforeach
        ...
        <script>
            $(function() {
                ...
                $('body').on('click', '#delete', function (event) {
                    ...
                    $.ajax(
                        {
                        url: "/bahan-baku-tetap/delete/" + id,
                        type: 'GET',
                        data: {
                            id: id
                        },
                ...
                $("body").on("click","#edit",function(e){
                    ...
                    let id = $(this).data('id');
                    let url = "/bahan-baku-tetap/edit/" + id;
                    // console.log(id);
